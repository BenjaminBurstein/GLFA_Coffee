...
export interface ApiCashCash extends Schema.CollectionType {
  ...
  attributes: {
    current_cash: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<2000>;
    update_date: Attribute.DateTime &
      Attribute.Required &
      Attribute.DefaultTo<'2023-12-31T23:00:00.000Z'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    purchase_cost: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiStockStock extends Schema.CollectionType {
  ...
  attributes: {
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    current_stock: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
      ...
      > &
      Attribute.DefaultTo<0>;
    purchase_count: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
